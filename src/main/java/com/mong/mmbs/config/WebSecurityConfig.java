...
public class WebSecurityConfig {
	...
	protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity //// 설정 맞추기
			...
			.authorizeRequests().antMatchers("/", "/api/auth/**", "/api/book/**", "/api/paymentInfo/**", "/api/orderInfo/**", "/api/orderPayment/**","/api/dtl/**","/api/best/**","/api/gift/**","/api/Image/**","/api/serch**").permitAll() 

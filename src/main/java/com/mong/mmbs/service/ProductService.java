...
//public ResponseDto<?> getProductAgeAll(String productAgeCategory) {
//		
//		List<ProductEntity> ProductAgeAll = null;
//		// 0~3
//		if (productAgeCategory.equals("1")) {
//					ProductAgeAll = productRepository.findByProductAgeAll(productAgeCategory);
//		}
//		return ResponseDto.setSuccess("Success", ProductAgeAll);
//		}
